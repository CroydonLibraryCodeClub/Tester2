...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Tester Demo Installer\n"
      else:
        line="OutputBaseFilename=Tester Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Tester Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Tester installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Tester Demo installer\n"
     else:
       line="SetupWindowTitle=Tester installer\n"
